...
public class ContrastShader implements Shaderable{

	private static final String VERTEX_SHADER_FILE = "shaders/contrastVertexShader";
	private static final String FRAGMENT_SHADER_FILE = "shaders/contrastFragmentShader";
	...
	public static ContrastShader createShader(List<Shaderable> shaders) {
