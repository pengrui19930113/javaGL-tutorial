...
//    	mat.m32 = 0;
	...
	public static FloatBuffer calculateModelViewProjectionMatrixBuffer(Camera camera, PolygonWater water) {
		Matrix4f mat = new Matrix4f();
    	Matrix4f.translate(new Vector3f(water.xPos, water.yPos, water.zPos), mat, mat);//translate
    	Matrix4f.mul(calculateViewMatrix(camera), mat, mat);
    	Matrix4f.mul(createProjectionMatrix(), mat, mat);
		pvBuffer.clear();
		mat.store(pvBuffer);
		pvBuffer.flip();
    	return pvBuffer;
