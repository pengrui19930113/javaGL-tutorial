...
public class MainGameLoop {
	...
	static final String WINDOW_TITLE = "Hello Uniform";
	...
	public static void main(String[] args) {
		...
		float entityPosX = 0, entityPosY = 0, entityPosZ = 0f;//-0.100001f;
		float entityRotX = 30, entityRotY = 0, entityRotZ = 0;
		...
		while (!Display.isCloseRequested()) {
			 ...
			 * logic
			 */
			entityPosZ -= 5.0*(frameStartTime-oldTime)/1000;
			if (entityPosZ < -10)
				entityPosZ = 0;
