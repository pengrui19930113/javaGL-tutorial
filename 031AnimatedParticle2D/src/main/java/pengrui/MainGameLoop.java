...
public class MainGameLoop {
	...
	static final String WINDOW_TITLE = "Hello Animated Particle";
	...
	public static void main(String[] args) {
		...
		ParticleShader particleShader = ParticleShader.createParticlesShader(shaders);
		Particle.loadParticleVao(vaos,vbos);
		ParticleSystem system = new ParticleSystem(60, 5f, 2f,TextureLoader.createTexture(textures, "textures/particles/cosmic.png"),4);
		fire = TextureLoader.createTexture(textures, "textures/particles/fire.png");
		smoke = TextureLoader.createTexture(textures, "textures/particles/smoke.png");
		...
		while (!Display.isCloseRequested()) {
			...
			EventManager.event(camera, entities, light, terrain, player, skybox,system);
			ActionManager.action(camera, entities, light, terrain, player,skybox,system,delta);
