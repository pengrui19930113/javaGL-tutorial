...
public class ParticleShader implements Shaderable{
	...
	public int location_texOffset1;
	public int location_texOffset2;
	public int location_texCoordInfo;
	@Override
	...
	public static ParticleShader createParticlesShader(List<Shaderable> shaders) {
		...
		shader.location_texOffset1 = GL20.glGetUniformLocation(shader.programID, "texOffset1");
		shader.location_texOffset2 = GL20.glGetUniformLocation(shader.programID, "texOffset2");
		shader.location_texCoordInfo = GL20.glGetUniformLocation(shader.programID,"texCoordInfo");
		//
