...
//				N1.w = water.height;//由于水的高度是0 所以改行注释
				...
				drawPlayer(playerShader,invertCamera,light,player);
...
//				N2.w = water.height;//由于水的高度是0 所以改行注释
		...
		drawBegin();
			...
			drawEntity(endityShader, camera, light, entities);
			drawSkyBox(skyboxShader,camera, light,skybox);
			drawWater(waterShader,camera,light,water);
	...
	static void drawWater(WaterShader shader, Camera camera, Light light, WaterTile water) {
