...
public class MainGameLoop {
	...
	static final String WINDOW_TITLE = "Hello SpecularLighting";
	...
	public static void main(String[] args) {
		...
		VAO vao = VAO.createObjVao(vaos, vbos,ClassLoader.getSystemResourceAsStream("models/dragon.obj"));
...
//		GL11.glFrontFace(GL11.GL_CW);
		...
		GL20.glUniform1f(shader.location_shineDamper,16f); //高光参数
		GL20.glUniform1f(shader.location_reflectivity, 0.8f);
