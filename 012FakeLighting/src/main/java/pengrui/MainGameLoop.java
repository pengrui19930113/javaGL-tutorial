...
public class MainGameLoop {
	...
	static final String WINDOW_TITLE = "Hello FakeLighting";
	...
	public static void main(String[] args) {
		...
		Entity entity = new Entity(VAO.createObjVao(vaos, vbos,"models/grassModel.obj"),TextureLoader.createTexture(textures,"textures/grassTexture.png"));
		entity.hasTransparency = true;
		entity.useFakeLighting = true;
