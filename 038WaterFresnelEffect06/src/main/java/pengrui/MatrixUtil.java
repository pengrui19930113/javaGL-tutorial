...
public class MatrixUtil {
	...
	public static void main(String[] args) {
		...
		caculateSkyboxViewMatrixBuffer(camera);
	}
	...
	public static FloatBuffer caculateTransformMatrixBuffer(Entity entity) {
	 ...
	 * @return
	 */
	public static FloatBuffer caculateTransformMatrixBuffer(Player player) {
		mat.setIdentity();
	...
	public static FloatBuffer caculateTransformMatrixBuffer(Terrain terrain) {
		mat.setIdentity();
	 ...
	 * @return
	 */
	public static FloatBuffer caculateTransformMatrixBuffer2(
...
//		Matrix4f.mul(tmp, mat, mat);//先平移 再旋转
	...
	public static FloatBuffer caculateViewMatrixBuffer(Camera camera) {
	...
	public static FloatBuffer caculateTransformMatrixBuffer(GuiEntity gui) {
		mat.setIdentity();
	...
	public static FloatBuffer caculateSkyboxViewMatrixBuffer(Camera camera) {
		mat.setIdentity();
...
//    	mat.m32 = 0;
	...
	public static FloatBuffer caculateModelMatrixBuffer(WaterTile water) {
		mat.setIdentity();
		Matrix4f.translate(new Vector3f(water.x,water.height,water.z),mat,mat);
		Matrix4f.scale(new Vector3f(WaterTile.SIZE, WaterTile.SIZE, WaterTile.SIZE), mat, mat);
    	buffer.clear();
    	mat.store(buffer);
    	buffer.flip();
		return buffer;
