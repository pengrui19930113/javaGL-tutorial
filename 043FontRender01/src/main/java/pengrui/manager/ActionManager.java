...
public class ActionManager {
	...
	public static void action(Camera camera, List<Entity> entities, Light light, Terrain terrain, Player player, Skybox skybox, List<NormalMappingEntity> normalEntities, long delta) {
