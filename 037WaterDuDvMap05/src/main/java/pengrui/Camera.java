...
public class Camera {
	...
	public float cameraPosX = 0, cameraPosY = 10f, cameraPosZ = 10f;
...
//			float yNormalizedDirect = -yDis/distanceFromPlayer;
	 ...
	 * @return
	 */
	public Camera getInvertCamera(WaterTile w) {
		Camera ic = new Camera(this.player);
		float distance = 2*(this.cameraPosY-w.height);
		ic.cameraPosY = this.cameraPosY - distance;
		ic.cameraRotX = -this.cameraRotX;
		
		ic.cameraPosX = this.cameraPosX;
		ic.cameraPosZ = this.cameraPosZ;
		ic.cameraRotY = this.cameraRotY;
		ic.cameraRotZ = this.cameraRotZ;
		return ic;
	}
}
