...
public class TerrainShader implements Shaderable{
	...
	public int location_toShadowMapSpace;
	public int location_shadowMap;
	...
	public static TerrainShader createShader(List<Shaderable> shaders) {
		...
		shader.location_toShadowMapSpace = GL20.glGetUniformLocation(shader.programID,"toShadowMapSpace");
		shader.location_shadowMap = GL20.glGetUniformLocation(shader.programID, "shadowMap");
		...
		GL20.glUniform1i(shader.location_shadowMap, 5);
		GL20.glUseProgram(0);
