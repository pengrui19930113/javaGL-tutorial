...
public class ShadowShader implements Shaderable{
	...
	public static ShadowShader createShader(List<Shaderable> shaders) {
		...
		GL20.glBindAttribLocation(shader.programID, PROGRAM_ATTRIBUTE_POSITION_INDEX, "in_position"); // 顶点着色器 的输入 根据  location 来识别
		GL20.glBindAttribLocation(shader.programID, PROGRAM_ATTRIBUTE_TEXTURE_COORDS_INDEX, "in_textureCoords"); 
