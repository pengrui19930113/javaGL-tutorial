...
public class MainGameLoop {
	...
	static final String WINDOW_TITLE = "Hello Water Begin";
	...
	public static void main(String[] args) {
		...
		while (!Display.isCloseRequested()) {
			...
			DrawManager.draw(entityShader,entities,camera,light,terrainShader,terrain,playerShader,player,guiShader,guis,skyboxShader,skybox,waterShader,water);
