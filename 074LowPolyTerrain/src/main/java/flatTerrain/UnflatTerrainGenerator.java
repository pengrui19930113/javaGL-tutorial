 ...
 *
 */
public class UnflatTerrainGenerator extends TerrainGenerator {

	private static final MyFile VERTEX_SHADER = new MyFile("flatTerrain", "unflatTerrainVertex.glsl");
	private static final MyFile FRAGMENT_SHADER = new MyFile("flatTerrain", "unflatTerrainFragment.glsl");
	 ...
	 */
	public UnflatTerrainGenerator(PerlinNoise perlinNoise, ColourGenerator colourGen, IndicesGenerator indicesGenerator) {
