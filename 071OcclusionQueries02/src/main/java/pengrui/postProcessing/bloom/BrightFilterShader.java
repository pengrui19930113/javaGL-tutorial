...
public class BrightFilterShader implements Shaderable{

	private static final String VERTEX_SHADER_FILE = "shaders/brightFilterVertexShader";
	private static final String FRAGMENT_SHADER_FILE = "shaders/brightFilterFragmentShader";
	...
	public static BrightFilterShader createShader(List<Shaderable> shaders) {
		BrightFilterShader shader = new BrightFilterShader();
		shaders.add(shader);
		// vertex shader
