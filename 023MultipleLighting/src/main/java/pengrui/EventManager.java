...
public class EventManager {
	...
	public static void event(Camera camera, List<Entity> entities, List<Light> lights, Terrain terrain, Player player) {
		keyboardEvent(camera, entities, lights, terrain, player);
		mouseEvent(camera, entities, lights, terrain, player);
	}
	static void mouseEvent(Camera camera, List<Entity> entities, List<Light> lights, Terrain terrain, Player player) {
	}
	static void keyboardEvent(Camera camera, List<Entity> entities, List<Light> lights, Terrain terrain, Player player) {
		//doCamera(camera);
	}
