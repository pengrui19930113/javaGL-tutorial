...
/**
 *
 * Fbo Multi-Target Render
 */
public class MainGameLoop {
	
	static final String WINDOW_TITLE = "Hello Fbo Multi-Target Render";
...
//			GL11.glPolygonMode(GL11.GL_FRONT_AND_BACK, GL11.GL_LINE);
	...
	static List<GuiEntity> createGuis(List<Integer> vaos, List<Integer> vbos, List<Integer> textures, PostProcessing postProcessing) {
		...
		list.add(new GuiEntity(0.8f, -0.8f, 0.2f, 0.2f, postProcessing.testMultiTargetRenderFbo.colourTexture));
