package pengrui.postProcessing.bloom;
...
public class CombineFilterShader implements Shaderable{

	private static final String VERTEX_SHADER_FILE = "shaders/combineFilterVertexShader";
	private static final String FRAGMENT_SHADER_FILE = "shaders/combineFilterFragmentShader";
	
	public int programID;
	public int fragmentShaderID;
	public int vertexShaderID;
	
	public int location_colourTexture;
	public int location_highlightTexture;
	@Override
	...
	public static CombineFilterShader createShader(List<Shaderable> shaders) {
		CombineFilterShader shader = new CombineFilterShader();
		shaders.add(shader);
		// vertex shader
		...
		shader.location_colourTexture = GL20.glGetUniformLocation(shader.programID, "colourTexture");
		shader.location_highlightTexture = GL20.glGetUniformLocation(shader.programID, "highlightTexture");
		//once uniform
		GL20.glUseProgram(shader.programID);
		GL20.glUniform1i(shader.location_colourTexture, 0);
		GL20.glUniform1i(shader.location_highlightTexture, 1);
		GL20.glUseProgram(0);
		return shader;
	}
