...
//		drawEnd();
	...
	static void drawProcessingQuad3(PostProcessing postProcessing) {
		...
		GL30.glBlitFramebuffer(0, 0, postProcessing.sceneFbo.width, postProcessing.sceneFbo.height
				, 0, 0, WIDTH, HEIGHT, GL11.GL_COLOR_BUFFER_BIT//|GL11.GL_DEPTH_BUFFER_BIT|GL11.GL_STENCIL_BUFFER_BIT //似乎不需要修改深度值 和模板值
				, GL11.GL_NEAREST);
		//attachment1
		GL30.glBindFramebuffer(GL30.GL_READ_FRAMEBUFFER, postProcessing.sceneFbo.framebuffer);
		GL11.glReadBuffer(GL30.GL_COLOR_ATTACHMENT1);
		GL30.glBindFramebuffer(GL30.GL_DRAW_FRAMEBUFFER, postProcessing.testMultiTargetRenderFbo.framebuffer);
		GL11.glDrawBuffer(GL30.GL_COLOR_ATTACHMENT0);
		GL30.glBlitFramebuffer(0, 0, postProcessing.sceneFbo.width, postProcessing.sceneFbo.height
				, 0, 0, postProcessing.testMultiTargetRenderFbo.width, postProcessing.testMultiTargetRenderFbo.height
