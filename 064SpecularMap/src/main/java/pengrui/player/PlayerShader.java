...
public class PlayerShader implements Shaderable{
	...
	private static final String VERTEX_SHADER_FILE = "shaders/playerVertexShader";
	private static final String FRAGMENT_SHADER_FILE = "shaders/playerFragmentShader";

	
	public static PlayerShader createShader(List<Shaderable> shaders) {
		...
		GL30.glBindFragDataLocation(shader.programID, 0, "fragmentOutColour");
		GL30.glBindFragDataLocation(shader.programID, 1, "fragmentOutColour2");
		...
		shader.location_projectionMatrix = GL20.glGetUniformLocation(shader.programID, "projectionMatrix1");
		shader.location_transformationMatrix = GL20.glGetUniformLocation(shader.programID, "transformationMatrix1");
		shader.location_viewMatrix = GL20.glGetUniformLocation(shader.programID,"viewMatrix1");
		shader.location_lightPosition = GL20.glGetUniformLocation(shader.programID, "lightPosition1");
		shader.location_lightColour = GL20.glGetUniformLocation(shader.programID,"lightColour1");
		shader.location_shineDamper = GL20.glGetUniformLocation(shader.programID, "shineDamper1");
		shader.location_reflectivity = GL20.glGetUniformLocation(shader.programID,"reflectivity1");
