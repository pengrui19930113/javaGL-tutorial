...
public class ParticleShader implements Shaderable{
	...
	public static ParticleShader createParticlesShader(List<Shaderable> shaders) {
		...
		GL20.glBindAttribLocation(shader.programID, 1, "modelViewMatrix");
		GL20.glBindAttribLocation(shader.programID, 5, "texOffsets");
		GL20.glBindAttribLocation(shader.programID, 6, "blendFactor");
