...
public class MainGameLoop {
	...
	static final String WINDOW_TITLE = "Hello Instance Render";
	...
	public static void main(String[] args) {
		...
		ParticleSystem system = new ParticleSystem(vaos,vbos,100, 5f, 2f,TextureLoader.createTexture(textures, "textures/particles/particleAtlas.png"),4);
