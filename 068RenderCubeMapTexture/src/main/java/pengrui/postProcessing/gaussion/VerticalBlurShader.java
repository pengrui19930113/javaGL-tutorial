package pengrui.postProcessing.gaussion;
...
public class VerticalBlurShader implements Shaderable{

	private static final String VERTEX_SHADER_FILE = "shaders/gaussianVerticalBlurVertexShader";
	...
	public int location_targetHeight;
	...
	public static VerticalBlurShader createShader(List<Shaderable> shaders) {
		VerticalBlurShader shader = new VerticalBlurShader();
		shaders.add(shader);
		// vertex shader
		...
		shader.location_targetHeight = GL20.glGetUniformLocation(shader.programID, "targetHeight");
		//once uniform
...
//		GL20.glUseProgram(0);
	...
	public void loadTargetHeight(int height) {
		...
		GL20.glUniform1f(location_targetHeight, height);
		GL20.glUseProgram(0);
	}
}
