...
public class PostProcessing {
	...
	public Fbo multiTargetFbo0;
	public Fbo multiTargetFbo1;
	...
	public PostProcessing(List<Integer>vaos,List<Integer>vbos,List<Integer> fbos,List<Integer> rbos,List<Integer>textures,List<Shaderable>shaders) {
		...
		this.multiTargetFbo0 = new Fbo(fbos,rbos,textures,WIDTH,HEIGHT,Fbo.DEPTH_TEXTURE);
		this.multiTargetFbo1 = new Fbo(fbos,rbos,textures,WIDTH,HEIGHT,Fbo.DEPTH_TEXTURE);
	}
}
