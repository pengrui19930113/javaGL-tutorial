...
public class MainGameLoop {
	...
	static final String WINDOW_TITLE = "Hello Dynamic Skybox";
	...
	public static void main(String[] args) {
		...
		while (!Display.isCloseRequested()) {
			...
			event(camera, entities, light, terrain, player,skybox);
			logic(camera, entities, light, terrain, player, skybox ,delta);
	...
	static void logic(Camera camera, List<Entity> entities, Light light, Terrain terrain, Player player, Skybox skybox, long delta) {
		ActionManager.action(camera, entities, light, terrain, player,skybox,delta);
	}
