...
//		Matrix4f.mul(tmp, mat, mat);//先平移 再旋转
	...
	public static FloatBuffer caculateSkyboxViewMatrix(Camera camera,Skybox skybox) {
		mat.setIdentity();
    	...
    	Matrix4f.rotate((float)Math.toRadians(skybox.rotation), Y_NORMAL_VECTOR, mat, mat);
