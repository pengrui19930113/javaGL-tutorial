...
public class DrawManager {
	...
	static void drawSkyBox(SkyboxShader shader, Camera camera, Light light, Skybox skybox) {
		...
		GL20.glUniformMatrix4(shader.location_viewMatrix, false, MatrixUtil.caculateSkyboxViewMatrix(camera,skybox));
		GL20.glUniform3f(shader.location_fogColour, SKY_COLOR_RED, SKY_COLOR_GREEN, SKY_COLOR_BLUE);
		GL20.glUniform1f(shader.location_blendFactor, skybox.blendFactor);
		
		GL30.glBindVertexArray(skybox.vao.vaoid);
		GL20.glEnableVertexAttribArray(0);
		GL13.glActiveTexture(GL13.GL_TEXTURE0);
		GL11.glBindTexture(GL13.GL_TEXTURE_CUBE_MAP, skybox.texture1);
		GL13.glActiveTexture(GL13.GL_TEXTURE1);
		GL11.glBindTexture(GL13.GL_TEXTURE_CUBE_MAP,skybox.texture2);
