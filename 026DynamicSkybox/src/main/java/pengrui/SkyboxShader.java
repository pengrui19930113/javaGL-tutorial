...
public class SkyboxShader implements Shaderable{
	...
	public int location_fogColour;
	public int location_cubeMap;
	public int location_cubeMap2;
	public int location_blendFactor;
	...
	public static SkyboxShader createShader(List<Shaderable> shaders) {
		...
		shader.location_fogColour = GL20.glGetUniformLocation(shader.programID,"fogColour");
		shader.location_cubeMap = GL20.glGetUniformLocation(shader.programID, "cubeMap");
		shader.location_cubeMap2 = GL20.glGetUniformLocation(shader.programID, "cubeMap2");
		shader.location_blendFactor = GL20.glGetUniformLocation(shader.programID, "blendFactor");
		
		GL20.glUseProgram(shader.programID);
		GL20.glUniform1i(shader.location_cubeMap, 0);//indicate the index of texture unit 
		GL20.glUniform1i(shader.location_cubeMap2, 1);
