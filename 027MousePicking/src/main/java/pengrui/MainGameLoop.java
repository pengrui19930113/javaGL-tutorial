...
public class MainGameLoop {
	public static final String WINDOW_TITLE = "Hello Mouse Picking";
	public static void main(String[] args) {
		...
		while (!Display.isCloseRequested()) {
			...
			event(camera, entities, light, terrain, player,skybox,picker);
			logic(camera, entities, light, terrain, player, skybox,picker,delta);
			draw(entityShader,entities,camera,light,terrainShader,terrain,playerShader,player,guiShader,guis,skyboxShader,skybox);
	...
	static void logic(Camera camera, List<Entity> entities, Light light, Terrain terrain, Player player, Skybox skybox, MousePicker picker, long delta) {
		ActionManager.action(camera, entities, light, terrain, player,skybox,picker,delta);
	}
	
	static void draw(EntityShader endityShader,List<Entity> entities
		...
		DrawManager.draw(endityShader, entities, camera, light, terrainShader, terrain, playerShader, player,guiShader,guis,skyboxShader,skybox);
	}
	
	public static void event(Camera camera, List<Entity> entities, Light light, Terrain terrain, Player player, Skybox skybox, MousePicker picker) {
		EventManager.event(camera, entities, light, terrain, player, skybox,picker);
	}
