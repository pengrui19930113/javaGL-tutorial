...
public class ActionManager {
	...
	public static void action(Camera camera, List<Entity> entities, Light light, Terrain terrain, Player player, Skybox skybox, MousePicker picker, long delta) {
//		System.out.println(camera);
//		doEntities(entities,delta);
		
		doCamera(camera,terrain,delta);
		doMousePicker(picker,terrain,camera,delta);
	}
	
	private static void doMousePicker(MousePicker picker, Terrain terrain, Camera camera, long delta) {
		picker.action(camera, terrain);
	}
