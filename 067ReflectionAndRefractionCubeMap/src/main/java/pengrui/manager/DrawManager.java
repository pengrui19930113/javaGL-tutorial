...
public class DrawManager {
	...
	public static void draw(EntityShader endityShader,List<Entity> entities,Camera camera,Light light
		...
		GL11.glViewport(0, 0, postProcessing.sceneFbo.width, postProcessing.sceneFbo.height);
			drawBegin();
				...
				drawReflectedEntity(reflectionEntityShader,camera,light,reflectedEntities,skybox);
				//drawParticles(particle3dShader,camera,light,system);
				drawSkyBox(skyboxShader,camera, light,skybox);
				//drawPolygonWater(polygonWaterShader,camera,light,water);
			drawEnd();
	...
	static void drawReflectedEntity(ReflectionEntityShader shader, Camera camera, Light light,
			List<ReflectionEntity> entities, Skybox skybox) {
	...
	static void drawPolygonWater(PolygonWaterShader shader, Camera camera, Light light,
			PolygonWater water) {
