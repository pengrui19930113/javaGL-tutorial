...
public class MainGameLoop {
	...
	public static void main(String[] args) {
		...
		List<Entity> entities = null; //createEntities(vaos,vbos,textures,terrain);
		...
		PolygonWater water = new PolygonWater(vaos,vbos);
		...
		while (!Display.isCloseRequested()) {
			...
			ActionManager.action(camera, entities, light, terrain, player,skybox,normalEntities,texts,fontEffect,system,water,delta);
	...
	static List<ReflectionEntity> createReflectedEntities(List<Integer> vaos, List<Integer> vbos,
		...
		ReflectionEntity entity = new ReflectionEntity(ObjVaoLoader.createObjVao(vaos,vbos,"models/meta.obj"),TextureLoader.createTexture(textures,"textures/meta.png"));
		entity.yPos = 4;
		entity.xSca = 0.5f;
		entity.ySca = 0.5f;
		entity.zSca = 0.5f;
		list.add(entity);
		entity = new ReflectionEntity(ObjVaoLoader.createObjVao(vaos,vbos,"models/tea.obj"),TextureLoader.createTexture(textures,"textures/tea.png"));
		entity.zPos = 4;
		entity.xSca = 0.34f;
		entity.ySca = 0.34f;
		entity.zSca = 0.34f;
		list.add(entity);
		entity = new ReflectionEntity(ObjVaoLoader.createObjVao(vaos,vbos,"models/dragon.obj"),TextureLoader.createTexture(textures,"textures/dragon.png"));
		entity.xPos = 4;
		entity.xSca = 0.3f;
		entity.ySca = 0.3f;
		entity.zSca = 0.3f;
		list.add(entity);
		entity = new ReflectionEntity(ObjVaoLoader.createObjVao(vaos,vbos,"models/sphere.obj"),TextureLoader.createTexture(textures,"textures/white.png"));
		list.add(entity);
		return list;
	}
