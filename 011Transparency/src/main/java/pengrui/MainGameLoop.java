...
public class MainGameLoop {
	...
	static final String WINDOW_TITLE = "Hello Transparency";
	...
	public static void main(String[] args) {
		...
		Entity entity = new Entity(VAO.createObjVao(vaos, vbos,"models/fern.obj"),TextureLoader.createTexture(textures,"textures/fern.png"));
